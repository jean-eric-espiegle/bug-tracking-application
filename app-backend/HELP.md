...
* The original package name 'com.jean-eric-espiegle.bug-tracking-application' is invalid and this project uses 'com.jean_eric_espiegle.bug_tracking_application' instead.
